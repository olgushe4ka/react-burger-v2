...
function IngredientDetails({ ingredients }) {
  return (
    ...
    >
      ...
      <p className={`${ingredientDetailsStyles.name} text text_type_main-medium  pl-0 pr-0 pb-8 pt-4`}      >
        {ingredients?.name}
      </p>
      <div className={`${ingredientDetailsStyles.infoBox}  pl-25 pr-25 pb-15 pt-0`}      >
        <div className={`${ingredientDetailsStyles.propBox} pl-0 pr-0 pb-0 pt-0`}        >
          <p className={`${ingredientDetailsStyles.textTipe} text text_type_main-small pl-0 pr-0 pb-2 pt-0`}         >
            Калории,ккал
          </p>
